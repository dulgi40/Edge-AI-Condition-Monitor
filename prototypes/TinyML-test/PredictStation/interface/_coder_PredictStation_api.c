/*
 * File: _coder_PredictStation_api.c
 *
                                 ...
                                 const char_T *identifier))[3]
{
  ...
  y = b_emlrt_marshallIn(sp, emlrtAlias(input_features), &thisId);
  emlrtDestroyArray(&input_features);
  return y;
}
...
void PredictStation_atexit(void)
{
  ...
  PredictStation_xil_terminate();
  PredictStation_xil_shutdown();
...
/*
 * File trailer for _coder_PredictStation_api.c
 *
 * [EOF]
 */
